...
const deleteKelas = async () => {
    ...
    try {
        await router.delete(route('kelas.delete', kelasToDelete.value.id));
        showDeleteModal.value = false;
    } catch (error) {
        console.error('Error mendelete kelas:', error);
    }
};
</script>
                ...
                >
                    <table class="w-full divide-gray-200 overflow-hidden">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <tr v-for="kelas in kelas.data" :key="kelas.id">
                                <td
                        ...
                        >
                            <div>
                                <p class="text-sm text-gray-700">
                                    Showing {{ kelas.from }} to
                                    {{ kelas.to }} of {{ kelas.total }} results
                                </p>
                            </div>
                            <div>
                                <nav
